...
If you want to get inspiration or just show something directly to your clients, you can jump-start your development with our pre-built example pages. Every page is spaced well, with attractive layouts and pleasing shapes. Shikshana MUI has everything you need to quickly set up an amazing project.
...
| [![Shikshana MUI](https://s3.amazonaws.com/creativetim_bucket/products/447/thumb/argon-dashboard-material-ui.jpg)](http://demos.creative-tim.com/argon-dashboard-material-ui/?ref=readme-admui)
...
The documentation for the Shikshana MUI is hosted at our [website](https://www.creative-tim.com/learning-lab/material-ui/overview/argon-dashboard/?ref=readme-admui).
...
We use GitHub Issues as the official bug tracker for the Shikshana MUI. Here are some advices for our users that want to report an issue:

1. Make sure that you are using the latest version of the Shikshana MUI. Check the CHANGELOG from your dashboard on our [website](https://www.creative-tim.com/product/argon-dashboard-material-ui?ref=readme-admui).
